...
namespace MvcAuto.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ManufacturersController(MvcAutoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Email")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Email")] Manufacturer manufacturer)
        {
